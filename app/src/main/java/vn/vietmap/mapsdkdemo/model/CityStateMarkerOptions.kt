package vn.vietmap.mapsdkdemo.model
...
class CityStateMarkerOptions :
    BaseMarkerOptions<CityStateMarker?, CityStateMarkerOptions?> {
    ...
    override fun getMarker(): CityStateMarker? {
        return infoWindowBackgroundColor?.let {
            CityStateMarker(
                this,
                it
            )
